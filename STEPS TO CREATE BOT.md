# ddos
# By Stoℝᴍ𒆜 BGMI | DDOS & EXCHANGE USERS @bgmisellingbuying @StoRm_BGMI_HACKS_STORE
...
1. Download the file from grp:
get key from @BeasTxt_Sasuke
...
2. Install the required libraries:
   ...
   ```sh
   chmod +x *
   ./install.sh             #after this click on rebuild then full rebuild
   pip install telebot
   pip install flask
   pip install aiogram
...
- `/attack1 <target> <port> <time>` - Initiate a DDoS attack on the specified target.
...
For any queries or support, contact [@BeasTxt_Sasuke](https://t.me/bgmisellingbuying)(https://t.me/StoRm_BGMI_HACKS_STORE) on Telegram. 
